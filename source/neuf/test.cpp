 ...
 * / code taken from: https://github.com/SnapDragon64/ACMFinalsSolutions/blob/master/finals2024/thesilkroadDK.cc, \
 * \ real genius                                                                                                  /
 *  --------------------------------------------------------------------------------------------------------------
 *         \   ^__^
 *          \  (xx)\_______
...
int main() {
	...
	while (cin >> N) {
		...
		for (int xi = 0; xi+1 < coords.size(); xi++)
		{
			Mat m = makeMat(xi);
			segTree[0].push_back(m);
		}
